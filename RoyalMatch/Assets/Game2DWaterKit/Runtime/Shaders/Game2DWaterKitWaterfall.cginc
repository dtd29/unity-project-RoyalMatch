...
#define Is_Waterfall2D_TopBottomEdgesTextureAlphaCutoff_Enabled defined(Waterfall2D_TopBottomEdgesTextureAlphaCutoff)
...
#define Waterfall2D_ApplyTopBottomEdgesAlphaCutoff (Waterfall2D_HasTopEdge || Waterfall2D_HasBottomEdge) && Is_Waterfall2D_TopBottomEdgesTextureAlphaCutoff_Enabled
	...
	// Top-Bottom Edges Variables
		...
		#if Waterfall2D_ApplyTopBottomEdgesAlphaCutoff
		half _TopBottomEdgesTextureAlphaCutoff;
		#endif
	#endif
	...
	inline half4 Waterfall2D_Frag (Varyings i)
	{
		...
		#if Waterfall2D_ApplyBodyAlphaCutoff || Waterfall2D_ApplyLeftRightEdgesAlphaCutoff || Waterfall2D_ApplyTopBottomEdgesAlphaCutoff
			half fragAlpha = 1.0;
		#endif
		...
		// Applying Top Edge Texture
			...
			#endif
			{
					...
					#if Waterfall2D_ApplyTopBottomEdgesAlphaCutoff
						fragAlpha = min(fragAlpha, topEdgeTextureColor.a);
					#endif
		...
		// Applying Bottom Edge Texture
			...
			#endif
			{
					...
					#if Waterfall2D_ApplyTopBottomEdgesAlphaCutoff
						fragAlpha = min(fragAlpha, bottomEdgeTextureColor.a);
					#endif
		...
		#if Waterfall2D_ApplyTopBottomEdgesAlphaCutoff
			finalColor.a *= (fragAlpha < _TopBottomEdgesTextureAlphaCutoff) ? 0.0 : 1.0;
		#endif
