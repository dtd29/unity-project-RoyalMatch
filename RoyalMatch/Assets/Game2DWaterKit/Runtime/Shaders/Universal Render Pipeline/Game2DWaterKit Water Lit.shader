	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag (Varyings i) : SV_Target
			{
				...
				half4 tintColor = Water2D_Frag(i, partiallySubmergedObjectsColor, backColor);
				#else
				half4 tintColor = Water2D_Frag(i, backColor);
				#endif

				#if Is_Water2D_ApplyEmissionColor_Enabled
					tintColor.rgb += tintColor.rgb * _WaterEmissionColor * _WaterEmissionColorIntensity;
				#endif

				tintColor = CombinedShapeLightShared(tintColor, 1.0, i.lightingUV);
				
				half4 c = 0;
				c.rgb = lerp(tintColor.rgb, tintColor.a * tintColor.rgb + (1.0 - tintColor.a) * backColor.rgb, backColor.a);
				c.a = backColor.a + (1.0 - backColor.a) * tintColor.a;
