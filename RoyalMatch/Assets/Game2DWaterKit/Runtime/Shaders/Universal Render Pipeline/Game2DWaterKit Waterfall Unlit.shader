Shader "Game2DWaterKit/Universal Render Pipeline/Unlit/Waterfall"
{
	Properties
	{
		// Body Properties
		...
		_TopBottomEdgesTextureAlphaCutoff("Top-Bottom Edges Texture Alpha Cutoff", Range(0.0,1.0)) = 0.1
		...
		_Waterfall2D_IsTopBottomEdgesTextureAlphaCutoffEnabled("Top-Bottom Edges Texture Alpha Cutoff Toggle", float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma shader_feature_local _ Waterfall2D_TopBottomEdgesTextureAlphaCutoff
